...
ALTER ROLE postgres WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION PASSWORD 'md5ec3ad8cbb942fe2ba1739e22fe393736';
...
SELECT pg_catalog.setval('"Nuage_id_seq"', 437, true);
